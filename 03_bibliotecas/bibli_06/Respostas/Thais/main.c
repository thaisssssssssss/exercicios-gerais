...
int main(){
    ...
    if(currentTemperature == 'c'){
        if(conversor == 'k'){
            ...
            printf("Temperature: %.2fF", convert_celsius_to_fahrenheit(temperature));
        }
    }
    else if(currentTemperature == 'k'){
        if(conversor == 'c'){
            printf("Temperature: %.2fC", convert_kelvin_to_celsius(temperature));
        }
        else if(conversor == 'f'){
            printf("Temperature: %.2fF", convert_kelvin_to_fahrenheit(temperature));
        }
    }
    else if(currentTemperature == 'f'){
        if(conversor == 'c'){
            printf("Temperature: %.2fC", convert_fahrenheit_to_celsius(temperature));
        }
        else if(conversor == 'k'){
